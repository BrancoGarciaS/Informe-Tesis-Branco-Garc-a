...
Como se mencionó, la variable \texttt{TIPOALTA} representa la verdad fundamental (\textit{ground truth}) del desenlace clínico de cada paciente (mortalidad). En el análisis de frecuencias presentado en la Tabla \ref{tab:frecuencia_tipo_alta} se puede observar que la tasa de mortalidad de los pacientes oncológicos duplicó y, en ocasiones, triplicó la tasa de mortalidad de la cohorte control. En específico, para los pacientes con cáncer, la cantidad de episodios con desenlace de muerte hospitalaria osciló entre el 5,4\% y el 6,9\%, mientras que, para el grupo control, la tasa de mortalidad se mantuvo entre el 2,3\% y el 3,7\%.
...
\hline
\parbox[t]{2.0cm}{\textbf{Condición al Egreso\\(Tipo de Alta)}} & 
...
% DOMICILIO
\parbox[t]{2.0cm}{\textbf{Domicilio}} 
...
% FALLECIDO
\parbox[t]{2.0cm}{\textbf{Fallecido}} 
...
\parbox[t]{2.0cm}{\textbf{Hosp. Domiciliaria}} 
...
\parbox[t]{2.0cm}{\textbf{Deriv. Hosp. Servicio}} 
...
% ALTA VOLUNTARIA
\parbox[t]{2.0cm}{\textbf{Alta Voluntaria}} 
...
\parbox[t]{2.0cm}{\textbf{Deriv. Red Nacional}} 
...
\parbox[t]{2.0cm}{\textbf{Deriv. Otros Centros (cárcel)}} 
...
\parbox[t]{2.0cm}{\textbf{Deriv. Inst. Privada\\(Compra Serv.)}} 
...
% FUGA DEL PACIENTE
\parbox[t]{2.0cm}{\textbf{Fuga del Paciente}} 
...
\parbox[t]{2.0cm}{\textbf{Deriv. Inst. Privada\\(Voluntario)}} 
...
\subsection{Cardinalidad y juicio sobre las de variables categóricas para la fase de modelado}
