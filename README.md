...
Nota: La plantilla soporta compilación con `latexmk` directamente. Si el motor disponible es XeLaTeX, se usará Arial; si cae en pdfTeX, la clase usa una fuente compatible para que la compilación siga funcionando.

Ejemplo de compilación:

```bash
latexmk tesis-usach.tex
```
